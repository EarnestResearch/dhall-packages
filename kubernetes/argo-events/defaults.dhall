{ Event =
      ./defaults/io.argoproj.common.Event.dhall sha256:f30584606b28268855070c7142f3120b44aa1fd07808175492b9e0462bbfba77
...
, Nats =
      ./defaults/io.argoproj.common.Nats.dhall sha256:70a1d83d7c4d9313eb7a93bc54e3f76f176fb419b3cd22d1efd05afe6502b852
    ? ./defaults/io.argoproj.common.Nats.dhall
, S3Artifact =
      ./defaults/io.argoproj.common.S3Artifact.dhall sha256:bb6abc15e01811f7e33d2323869605fd982a5ae168eb808b0c18e91bf8376dfb
    ? ./defaults/io.argoproj.common.S3Artifact.dhall
, S3Bucket =
      ./defaults/io.argoproj.common.S3Bucket.dhall sha256:dcf7f71ee897c47787969cefa51ae89a40d88d452adb74a9451fd1534c5ad901
    ? ./defaults/io.argoproj.common.S3Bucket.dhall
, S3Filter =
      ./defaults/io.argoproj.common.S3Filter.dhall sha256:9bb9dcb5bf6f795291686f59383bcd01c8e79b87fc3fb63351d46dea100ac51b
    ? ./defaults/io.argoproj.common.S3Filter.dhall
, ServiceTemplateSpec =
      ./defaults/io.argoproj.common.ServiceTemplateSpec.dhall sha256:93331fd11a7866a7b2bf39f8df684606d8b94f08546e2e0afe91dcb7b16d7d0c
...
, NotificationWatchers =
      ./defaults/io.argoproj.gateway.v1alpha1.NotificationWatchers.dhall sha256:fd18ffa760bda5556b5cfda1f7df8605a0997e075a1b855966e2364387fe4702
...
, ConfigmapArtifact =
      ./defaults/io.argoproj.sensor.v1alpha1.ConfigmapArtifact.dhall sha256:9bb9dcb5bf6f795291686f59383bcd01c8e79b87fc3fb63351d46dea100ac51b
    ? ./defaults/io.argoproj.sensor.v1alpha1.ConfigmapArtifact.dhall
, DataFilter =
      ./defaults/io.argoproj.sensor.v1alpha1.DataFilter.dhall sha256:21f12b6ca019c905bf875c85b14ecb89026eedc5ec9109f862cf2f58bad10a89
...
, GitArtifact =
      ./defaults/io.argoproj.sensor.v1alpha1.GitArtifact.dhall sha256:d945b2eac51c767966e2243582f5ad3afcfa20f025bc73284dcbd22c774e8340
    ? ./defaults/io.argoproj.sensor.v1alpha1.GitArtifact.dhall
, GitCreds =
      ./defaults/io.argoproj.sensor.v1alpha1.GitCreds.dhall sha256:9bb9dcb5bf6f795291686f59383bcd01c8e79b87fc3fb63351d46dea100ac51b
...
, TriggerParameter =
      ./defaults/io.argoproj.sensor.v1alpha1.TriggerParameter.dhall sha256:e4e97bd692c79fb6f5a49b4d6536fbcec4d16283fa5b9e074d1eeb4b4e1d45de
    ? ./defaults/io.argoproj.sensor.v1alpha1.TriggerParameter.dhall
, TriggerParameterSource =
      ./defaults/io.argoproj.sensor.v1alpha1.TriggerParameterSource.dhall sha256:885dac129f425e4f13068ac0093f97dfcf4030a6ba0830ea54e3ebf04c2393b5
    ? ./defaults/io.argoproj.sensor.v1alpha1.TriggerParameterSource.dhall
, TriggerPolicy =
      ./defaults/io.argoproj.sensor.v1alpha1.TriggerPolicy.dhall sha256:877ac60f91b366bcc7a498cd8e38553a7ed9cd6e9c8e80673e97f455e484815a
