{ dependencies : List ./io.argoproj.sensor.v1alpha1.EventDependency.dhall
, dependencyGroups : List ./io.argoproj.sensor.v1alpha1.DependencyGroup.dhall
...
, triggers : List ./io.argoproj.sensor.v1alpha1.Trigger.dhall
